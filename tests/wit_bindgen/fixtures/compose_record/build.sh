...
wac plug consumer.wasm --plug provider.wasm -o composed_record.wasm
wasm-tools validate composed_record.wasm
echo "built composed_record.wasm (consumer.runner.run -> 26)"
